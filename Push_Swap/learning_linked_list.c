// code from lowlevellearning
// commented by me to understand linked lists

#include <stdio.h>
#include <stdlib.h>

typedef struct { //typedef removes the necessity to tyoe struct every time
    void *next;
    int data;
} Node; // represents a single node in list
